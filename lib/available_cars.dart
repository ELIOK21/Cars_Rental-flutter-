import 'package:cars_rental/car_widget.dart';
import 'package:flutter/material.dart';
import 'package:cars_rental/constants.dart';
import 'package:cars_rental/data.dart';
import 'package:cars_rental/book_car.dart';
            ...
            children: [
              ...
              Expanded(
                child: GridView.count(
                  ...
                  crossAxisSpacing: 15,
                  mainAxisSpacing: 15,
                  children: getCarList().asMap().entries.map((entry) {
                    int index = entry.key;
                    Car item = entry.value;
                    ...
                    return GestureDetector(
                      ...
                      child: buildCar(item,
                          index), // Pass the index or the appropriate value
                    );
                  }).toList(),
                ),
              ),
